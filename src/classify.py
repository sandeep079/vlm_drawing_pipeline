...
def extract_text(pdf_path, image, model, processor):
    # 1. Native PDF text extraction (Fast & 100% accurate)
    extracted = ""
    try:
...
def classify_drawing(pdf_path, output_dir="output"):
    ...
    out_data = {"drawing_id": drawing_id, "class": part_class, "class_confidence": conf, "class_evidence": evidence}
